...
declare class Tree extends React.Component<TreeProps, TreeState> {
     ...
     */
    handleOnNodeClickCb: (nodeId: string, evt: SyntheticEvent) => void;
    /**
     ...
     */
    handleOnNodeMouseOverCb: (nodeId: string, evt: SyntheticEvent) => void;
    /**
     ...
     */
    handleOnNodeMouseOutCb: (nodeId: string, evt: SyntheticEvent) => void;
    /**
